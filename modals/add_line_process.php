            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-4">
                        ...
                        <input class="form-control form-control-sm form-control-border text-xs" id="line_m" type="text">
                    </div>
                    <div class="col-4">
                        <label class="m-0 p-0 font-weight-normal text-xs">Process</label>
                        <input class="form-control form-control-sm form-control-border text-xs" id="process_m" type="text">
                    </div>
                </div>
            </div>

            <div class="modal-footer bg-light d-flex justify-content-end">
                <button class="btn btn-primary btn-sm w-25 text-xs" onclick="register_line_process()">Add</button>
            </div>
        </div>
    </div>
</div>