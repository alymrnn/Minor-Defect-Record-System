        ...
        <di class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-2 mb-2">
              ...
              <input type="text" id="search_defect_category" class="form-control" placeholder="Defect Category"
                autocomplete="off" class="pl-3"
                style="color: #525252;font-size: 15px;border-radius: .25rem;border: 1px solid #888888;background: #FFF;height:34px; width:100%;">
            </div>
            <div class="col-12 col-sm-6 col-md-2 mb-2">
              <!-- defect details -->
              <label style="font-weight:normal;margin:0;padding:0;color:#000;">Defect Details</label>
              <input type="text" id="search_defect_details" class="form-control" placeholder="Defect Details"
                autocomplete="off" class="pl-3"
                style="color: #525252;font-size: 15px;border-radius: .25rem;border: 1px solid #888888;background: #FFF;height:34px; width:100%;">
            </div>
          ...
          <div class="row justify-content-end">
            ...
            <div class=" col-12 col-sm-4 col-md-2 mt-3">
              <!-- export button -->
              <button class="btn btn-block d-flex justify-content-left" id="export_record" onclick="()"
                style="color:#fff;height:34px;background: #335c67;font-size:15px;font-weight:normal;"
            ...
            <div class=" col-12 col-sm-4 col-md-2 mt-3">
              ...
              <button class="btn btn-block d-flex justify-content-left" data-toggle="modal"
                ...
                style="color:#fff;height:34px;background: #9e2a2b;font-size:15px;font-weight:normal;"
