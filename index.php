        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 col-sm-6 col-md-2 mb-2">
              <!-- line no. -->
              <label style="font-weight:normal;margin:0;padding:0;color:#000;font-size:14px;">Line No.</label>
            ...
            <div class="col-12 col-sm-6 col-md-4 mb-2" style="display: none;">
              <!-- qr scan -->
              <label style="font-weight:normal;margin:0;padding:0;color:#000;font-size:14px;">Scan here</label>
              <input type="text" id="scan_qr" class="form-control pl-3" autocomplete="off"
                style="color: #525252;font-size: 14px;border-radius: .25rem;border: 1px solid #adb5bd;background: #FFF;height:35px; width:100%;">
            </div>
            <div class="col-12 col-sm-6 col-md-2 mb-2">
              <!-- product name -->
              <label style="font-weight:normal;margin:0;padding:0;color:#000;font-size:14px;">Product Number</label>
            ...
            <div class="col-12 col-sm-6 col-md-2 mb-2">
              <!-- lot no -->
              <label style="font-weight:normal;margin:0;padding:0;color:#000;font-size:14px;">Lot No.</label>
              <input type="text" id="scan_lot_no" class="form-control pl-3" placeholder="Lot No." autocomplete="off"
                style="color: #525252;font-size: 14px;border-radius: .25rem;border: 1px solid #adb5bd;background: #FFF;height:35px; width:100%;">
            </div>
            <div class="col-12 col-sm-6 col-md-2 mb-2">
              <!-- serial no -->
              <label style="font-weight:normal;margin:0;padding:0;color:#000;font-size:14px;">Serial No.</label>
            ...
            <div class="col-12 col-sm-4 col-md-2">
              ...
              <button class="btn btn-block d-flex justify-content-left" id="export_record"
                ...
                style="color:#fff;height:35px;background: #335c67;font-size:14px;font-weight:normal;"
            ...
            <div class="col-12 col-sm-6 col-md-2">
              ...
              <button class="btn btn-block d-flex justify-content-left" id="search_btn" onclick="load_defect_table(1)"
                style="color:#fff;height:35px;border-radius:.25rem;background: #2D2D2D;font-size:14px;font-weight:normal;"
          ...
          <div class="row mt-1">
            ...
            <div class="col-12 col-sm-6 col-md-2 mb-2">
              <!-- process -->
              <label style="font-weight:normal;margin:0;padding:0;color:#000;font-size:14px;">Process</label>
            ...
            <div class="col-12 col-sm-6 col-md-2 mb-2">
              <!-- defect category -->
              <label style="font-weight:normal;margin:0;padding:0;color:#000;font-size:14px;">Defect Category</label>
            ...
            <div class="col-12 col-sm-6 col-md-2 mb-2">
              <!-- defect details -->
              <label style="font-weight:normal;margin:0;padding:0;color:#000;font-size:14px;">Defect Details</label>
            ...
            <div class="col-12 col-sm-4 col-md-2">
              ...
              <button id="add_record_btn" class="btn btn-block d-flex justify-content-left" data-toggle="modal"
                ...
                style="color:#fff;height:35px;background: #9e2a2b;font-size:14px;font-weight:normal;"
                onmouseover="this.style.backgroundColor='#792021'; this.style.color='#FFF';"
                onmouseout="this.style.backgroundColor='#9e2a2b'; this.style.color='#FFF';"><i class="fas fa-plus"></i>&nbsp;Add Record</button>
            </div>
          </div>
          <div class="row">
